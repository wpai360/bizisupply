...
<?php } ?>
    ...
    <thead>
        ...
        <tr class="ref">
          ...
          <th scope="col">Awaiting Supplier Response</th>     
 ...
 <?php //pr($draftOrder); ?>
        ...
        <tr>
            ...
            <td  style="text-align:center;"><?php if(!empty($savedtOrder[$i]->awaiting_supplie_response !=0)){ echo $savedtOrder[$i]->awaiting_supplie_response.' '.'Offers';} else {echo '0'.' '.'Offers';}?>  </td>
