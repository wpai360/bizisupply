  		...
  		<div class="col-sm-12">
  			...
  			<form class="form-horizontal formPost" method="POST" enctype="multipart/form-data">
  				<div class="form-group">
			        ...
			        <div class="col-sm-10">         
			          <div class="col-sm-10">
			            <input type="text" class="form-control" id="Name" name="Name" placeholder="Enter Service Name"   Value="<?php echo (isset($single_data->name))? $single_data->name : "" ;   ?>" />
			      ...
			      <div class="form-group">
			        <label for="is_active" class="col-sm-2 control-label">Service Image *</label>
			        <div class="col-sm-10">         
			          <div class="col-sm-6">
			          	<input type="file" name="ServiceImage" id="uploadFile" />
			          	<span id="error_msg_image" class="text-danger"></span>
			          </div>
			          	<div class="col-sm-4">
			          		<?php (!empty($single_data->upload_image)) ? $imgPath = base_url('assets/uploads/service_images/').$single_data->upload_image  : $imgPath = base_url("assets/images/add-image.jpg");    ?>
			          		<img class="previewimg" height="130px" width="130px"  src="<?php echo $imgPath; ?>" alt="Service-image" id="upload_post_image"> 
			    ...
			    <div class="form-group">
			        <div class="col-sm-offset-2 col-sm-10">
			          <button type="submit" name="update_service" class="btn btn-danger">Update Now</button>
			        </div>
			    </div>
  			</form>
  		</div>
