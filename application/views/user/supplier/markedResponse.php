...
?>
    <h4><b>Feedback <b></h4>
<?php   echo $num_rows->rate.'<br>';

$round = $num_rows->star_rating;
if ($round == 1) {
        ...
        echo '<span class="fa fa-star checked"></span><span class="fa fa-star"  checked></span><span class="fa fa-star"></span><span class="fa fa-star"></span> <span class="fa fa-star"></span>'; } elseif ($round == 3) {
