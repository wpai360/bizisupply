      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown notifications-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <span id="newnoti" class="label label-warning">

            </span> 
          </a>
          <ul class="dropdown-menu">
            <li class="header" id="total"></li>
            <li>
              <!-- inner menu: contains the actual data -->
              <ul class="menu" id="msg-notif">
                <!-- <li>
                  <a href="#">
            ...
            <li class="footer" id="noti-update"><a href="<?php echo base_url('admin/view-notifications');?>">View all</a></li>
          </ul>
        </li>
...
<li class="dropdown user user-menu">
  ...
  ?>
    ...
    <img src="<?= $src;?>" class="user-image" alt="User Image">
       <span class="hidden-xs"><?php if($user->username){echo ucfirst($user->username); }else {echo "Admin";}?></span>
  ...
  <ul class="dropdown-menu">
    ...
    <li class="user-footer">
      ...
      <div class="pull-right">
       ...
       <?php 
       echo anchor('admin/logOut', 'LogOut', 'class="btn btn-default btn-flat"');
       ?>
     </div>
   </li>
 </ul>
