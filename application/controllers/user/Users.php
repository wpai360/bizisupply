...
class Users extends CI_Controller
{
    ...
    */
    ...
    public function orderSubmitRequest($draftStatus, $userId)
    {
        ...
        $brand_name_11 =  $this->input->post('brand_name_11');
        $product_11 =  $this->input->post('product_11');
        $partNumber_11 =  $this->input->post('partNumber_11');
        $quantity_11 =  $this->input->post('quantity_11');

        $brand_name_12 =  $this->input->post('brand_name_12');
        $product_12 =  $this->input->post('product_12');
        $partNumber_12 =  $this->input->post('partNumber_12');
        $quantity_12 =  $this->input->post('quantity_12');

        $brand_name_13 =  $this->input->post('brand_name_13');
        $product_13 =  $this->input->post('product_13');
        $partNumber_13 =  $this->input->post('partNumber_13');
        $quantity_13 =  $this->input->post('quantity_13');

        $brand_name_14 =  $this->input->post('brand_name_14');
        $product_14 =  $this->input->post('product_14');
        $partNumber_14 =  $this->input->post('partNumber_14');
        $quantity_14 =  $this->input->post('quantity_14');

        $brand_name_15 =  $this->input->post('brand_name_15');
        $product_15 =  $this->input->post('product_15');
        $partNumber_15 =  $this->input->post('partNumber_15');
        $quantity_15 =  $this->input->post('quantity_15');

        $brand_name_16 =  $this->input->post('brand_name_16');
        $product_16 =  $this->input->post('product_16');
        $partNumber_16 =  $this->input->post('partNumber_16');
        $quantity_16 =  $this->input->post('quantity_16');

        $brand_name_17 =  $this->input->post('brand_name_17');
        $product_17 =  $this->input->post('product_17');
        $partNumber_17 =  $this->input->post('partNumber_17');
        $quantity_17 =  $this->input->post('quantity_17');

        $brand_name_18 =  $this->input->post('brand_name_18');
        $product_18 =  $this->input->post('product_18');
        $partNumber_18 =  $this->input->post('partNumber_18');
        $quantity_18 =  $this->input->post('quantity_18');

        $brand_name_19 =  $this->input->post('brand_name_19');
        $product_19 =  $this->input->post('product_19');
        $partNumber_19 =  $this->input->post('partNumber_19');
        $quantity_19 =  $this->input->post('quantity_19');

        $brand_name_20 =  $this->input->post('brand_name_20');
        $product_20 =  $this->input->post('product_20');
        $partNumber_20 =  $this->input->post('partNumber_20');
        $quantity_20 =  $this->input->post('quantity_20');

        $masterlist_option_11 = $this->input->post('master_list_product_11');
        $masterlist_option_12 = $this->input->post('master_list_product_12');
        $masterlist_option_13 = $this->input->post('master_list_product_13');
        $masterlist_option_14 = $this->input->post('master_list_product_14');
        $masterlist_option_15 = $this->input->post('master_list_product_15');
        $masterlist_option_16 = $this->input->post('master_list_product_16');
        $masterlist_option_17 = $this->input->post('master_list_product_17');
        $masterlist_option_18 = $this->input->post('master_list_product_18');
        $masterlist_option_19 = $this->input->post('master_list_product_19');
        $masterlist_option_20 = $this->input->post('master_list_product_20');

        $brand_name_21 =  $this->input->post('brand_name_21');
        $product_21 =  $this->input->post('product_21');
        $partNumber_21 =  $this->input->post('partNumber_21');
        $quantity_21 =  $this->input->post('quantity_21');

        $brand_name_22 =  $this->input->post('brand_name_22');
        $product_22 =  $this->input->post('product_22');
        $partNumber_22 =  $this->input->post('partNumber_22');
        $quantity_22 =  $this->input->post('quantity_22');

        $brand_name_23 =  $this->input->post('brand_name_23');
        $product_23 =  $this->input->post('product_23');
        $partNumber_23 =  $this->input->post('partNumber_23');
        $quantity_23 =  $this->input->post('quantity_23');

        $brand_name_24 =  $this->input->post('brand_name_24');
        $product_24 =  $this->input->post('product_24');
        $partNumber_24 =  $this->input->post('partNumber_24');
        $quantity_24 =  $this->input->post('quantity_24');

        $brand_name_25 =  $this->input->post('brand_name_25');
        $product_25 =  $this->input->post('product_25');
        $partNumber_25 =  $this->input->post('partNumber_25');
        $quantity_25 =  $this->input->post('quantity_25');

        $brand_name_26 =  $this->input->post('brand_name_26');
        $product_26 =  $this->input->post('product_26');
        $partNumber_26 =  $this->input->post('partNumber_26');
        $quantity_26 =  $this->input->post('quantity_26');

        $brand_name_27 =  $this->input->post('brand_name_27');
        $product_27 =  $this->input->post('product_27');
        $partNumber_27 =  $this->input->post('partNumber_27');
        $quantity_27 =  $this->input->post('quantity_27');

        $brand_name_28 =  $this->input->post('brand_name_28');
        $product_28 =  $this->input->post('product_28');
        $partNumber_28 =  $this->input->post('partNumber_28');
        $quantity_28 =  $this->input->post('quantity_28');

        $brand_name_29 =  $this->input->post('brand_name_29');
        $product_29 =  $this->input->post('product_29');
        $partNumber_29 =  $this->input->post('partNumber_29');
        $quantity_29 =  $this->input->post('quantity_29');

        $brand_name_30 =  $this->input->post('brand_name_30');
        $product_30 =  $this->input->post('product_30');
        $partNumber_30 =  $this->input->post('partNumber_30');
        $quantity_30 =  $this->input->post('quantity_30');

        $masterlist_option_21 = $this->input->post('master_list_product_21');
        $masterlist_option_22 = $this->input->post('master_list_product_22');
        $masterlist_option_23 = $this->input->post('master_list_product_23');
        $masterlist_option_24 = $this->input->post('master_list_product_24');
        $masterlist_option_25 = $this->input->post('master_list_product_25');
        $masterlist_option_26 = $this->input->post('master_list_product_26');
        $masterlist_option_27 = $this->input->post('master_list_product_27');
        $masterlist_option_28 = $this->input->post('master_list_product_28');
        $masterlist_option_29 = $this->input->post('master_list_product_29');
        $masterlist_option_30 = $this->input->post('master_list_product_30');

        $brand_name_31 =  $this->input->post('brand_name_31');
        $product_31 =  $this->input->post('product_31');
        $partNumber_31 =  $this->input->post('partNumber_31');
        $quantity_31 =  $this->input->post('quantity_31');

        $brand_name_32 =  $this->input->post('brand_name_32');
        $product_32 =  $this->input->post('product_32');
        $partNumber_32 =  $this->input->post('partNumber_32');
        $quantity_32 =  $this->input->post('quantity_32');

        $brand_name_33 =  $this->input->post('brand_name_33');
        $product_33 =  $this->input->post('product_33');
        $partNumber_33 =  $this->input->post('partNumber_33');
        $quantity_33 =  $this->input->post('quantity_33');

        $brand_name_34 =  $this->input->post('brand_name_34');
        $product_34 =  $this->input->post('product_34');
        $partNumber_34 =  $this->input->post('partNumber_34');
        $quantity_34 =  $this->input->post('quantity_34');

        $brand_name_35 =  $this->input->post('brand_name_35');
        $product_35 =  $this->input->post('product_35');
        $partNumber_35 =  $this->input->post('partNumber_35');
        $quantity_35 =  $this->input->post('quantity_35');

        $brand_name_36 =  $this->input->post('brand_name_36');
        $product_36 =  $this->input->post('product_36');
        $partNumber_36 =  $this->input->post('partNumber_36');
        $quantity_36 =  $this->input->post('quantity_36');

        $brand_name_37 =  $this->input->post('brand_name_37');
        $product_37 =  $this->input->post('product_37');
        $partNumber_37 =  $this->input->post('partNumber_37');
        $quantity_37 =  $this->input->post('quantity_37');

        $brand_name_38 =  $this->input->post('brand_name_38');
        $product_38 =  $this->input->post('product_38');
        $partNumber_38 =  $this->input->post('partNumber_38');
        $quantity_38 =  $this->input->post('quantity_38');

        $brand_name_39 =  $this->input->post('brand_name_39');
        $product_39 =  $this->input->post('product_39');
        $partNumber_39 =  $this->input->post('partNumber_39');
        $quantity_39 =  $this->input->post('quantity_39');

        $brand_name_40 =  $this->input->post('brand_name_40');
        $product_40 =  $this->input->post('product_40');
        $partNumber_40 =  $this->input->post('partNumber_40');
        $quantity_40 =  $this->input->post('quantity_40');

        $masterlist_option_31 = $this->input->post('master_list_product_31');
        $masterlist_option_32 = $this->input->post('master_list_product_32');
        $masterlist_option_33 = $this->input->post('master_list_product_33');
        $masterlist_option_34 = $this->input->post('master_list_product_34');
        $masterlist_option_35 = $this->input->post('master_list_product_35');
        $masterlist_option_36 = $this->input->post('master_list_product_36');
        $masterlist_option_37 = $this->input->post('master_list_product_37');
        $masterlist_option_38 = $this->input->post('master_list_product_38');
        $masterlist_option_39 = $this->input->post('master_list_product_39');
        $masterlist_option_40 = $this->input->post('master_list_product_40');

        $brand_name_41 =  $this->input->post('brand_name_41');
        $product_41 =  $this->input->post('product_41');
        $partNumber_41 =  $this->input->post('partNumber_41');
        $quantity_41 =  $this->input->post('quantity_41');

        $brand_name_42 =  $this->input->post('brand_name_42');
        $product_42 =  $this->input->post('product_42');
        $partNumber_42 =  $this->input->post('partNumber_42');
        $quantity_42 =  $this->input->post('quantity_42');

        $brand_name_43 =  $this->input->post('brand_name_43');
        $product_43 =  $this->input->post('product_43');
        $partNumber_43 =  $this->input->post('partNumber_43');
        $quantity_43 =  $this->input->post('quantity_43');

        $brand_name_44 =  $this->input->post('brand_name_44');
        $product_44 =  $this->input->post('product_44');
        $partNumber_44 =  $this->input->post('partNumber_44');
        $quantity_44 =  $this->input->post('quantity_44');

        $brand_name_45 =  $this->input->post('brand_name_45');
        $product_45 =  $this->input->post('product_45');
        $partNumber_45 =  $this->input->post('partNumber_45');
        $quantity_45 =  $this->input->post('quantity_45');

        $brand_name_46 =  $this->input->post('brand_name_46');
        $product_46 =  $this->input->post('product_46');
        $partNumber_46 =  $this->input->post('partNumber_46');
        $quantity_46 =  $this->input->post('quantity_46');

        $brand_name_47 =  $this->input->post('brand_name_47');
        $product_47 =  $this->input->post('product_47');
        $partNumber_47 =  $this->input->post('partNumber_47');
        $quantity_47 =  $this->input->post('quantity_47');

        $brand_name_48 =  $this->input->post('brand_name_48');
        $product_48 =  $this->input->post('product_48');
        $partNumber_48 =  $this->input->post('partNumber_48');
        $quantity_48 =  $this->input->post('quantity_48');

        $brand_name_49 =  $this->input->post('brand_name_49');
        $product_49 =  $this->input->post('product_49');
        $partNumber_49 =  $this->input->post('partNumber_49');
        $quantity_49 =  $this->input->post('quantity_49');

        $brand_name_50 =  $this->input->post('brand_name_50');
        $product_50 =  $this->input->post('product_50');
        $partNumber_50 =  $this->input->post('partNumber_50');
        $quantity_50 =  $this->input->post('quantity_50');

        $masterlist_option_41 = $this->input->post('master_list_product_41');
        $masterlist_option_42 = $this->input->post('master_list_product_42');
        $masterlist_option_43 = $this->input->post('master_list_product_43');
        $masterlist_option_44 = $this->input->post('master_list_product_44');
        $masterlist_option_45 = $this->input->post('master_list_product_45');
        $masterlist_option_46 = $this->input->post('master_list_product_46');
        $masterlist_option_47 = $this->input->post('master_list_product_47');
        $masterlist_option_48 = $this->input->post('master_list_product_48');
        $masterlist_option_49 = $this->input->post('master_list_product_49');
        $masterlist_option_50 = $this->input->post('master_list_product_50');
        ...
        for ($i=0;$i< $countMaxArraySize;$i++) {
            ...
            $arr[$i] =	[
                                ...
                                'brand_name_11'=>$brand_name_11[$i],
                                'order_name_11'=>$product_11[$i],
                                'part_number_11'=>$partNumber_11[$i],
                                'quantity_11'=>$quantity_11[$i],
                                'brand_name_12'=>$brand_name_12[$i],
                                'order_name_12'=>$product_12[$i],
                                'part_number_12'=>$partNumber_12[$i],
                                'quantity_12'=>$quantity_12[$i],
                                'brand_name_13'=>$brand_name_13[$i],
                                'order_name_13'=>$product_13[$i],
                                'part_number_13'=>$partNumber_13[$i],
                                'quantity_13'=>$quantity_13[$i],
                                'brand_name_14'=>$brand_name_14[$i],
                                'order_name_14'=>$product_14[$i],
                                'part_number_14'=>$partNumber_14[$i],
                                'quantity_14'=>$quantity_14[$i],
                                'brand_name_15'=>$brand_name_15[$i],
                                'order_name_15'=>$product_15[$i],
                                'part_number_15'=>$partNumber_15[$i],
                                'quantity_15'=>$quantity_15[$i],
                                'brand_name_16'=>$brand_name_16[$i],
                                'order_name_16'=>$product_16[$i],
                                'part_number_16'=>$partNumber_16[$i],
                                'quantity_16'=>$quantity_16[$i],
                                'brand_name_17'=>$brand_name_17[$i],
                                'order_name_17'=>$product_17[$i],
                                'part_number_17'=>$partNumber_17[$i],
                                'quantity_17'=>$quantity_17[$i],
                                'brand_name_18'=>$brand_name_18[$i],
                                'order_name_18'=>$product_18[$i],
                                'part_number_18'=>$partNumber_18[$i],
                                'quantity_18'=>$quantity_18[$i],
                                'brand_name_19'=>$brand_name_19[$i],
                                'order_name_19'=>$product_19[$i],
                                'part_number_19'=>$partNumber_19[$i],
                                'quantity_19'=>$quantity_19[$i],
                                'brand_name_20'=>$brand_name_20[$i],
                                'order_name_20'=>$product_20[$i],
                                'part_number_20'=>$partNumber_20[$i],
                                'quantity_20'=>$quantity_20[$i],
                                'brand_name_21'=>$brand_name_21[$i],
                                'order_name_21'=>$product_21[$i],
                                'part_number_21'=>$partNumber_21[$i],
                                'quantity_21'=>$quantity_21[$i],
                                'brand_name_22'=>$brand_name_22[$i],
                                'order_name_22'=>$product_22[$i],
                                'part_number_22'=>$partNumber_22[$i],
                                'quantity_22'=>$quantity_22[$i],
                                'brand_name_23'=>$brand_name_23[$i],
                                'order_name_23'=>$product_23[$i],
                                'part_number_23'=>$partNumber_23[$i],
                                'quantity_23'=>$quantity_23[$i],
                                'brand_name_24'=>$brand_name_24[$i],
                                'order_name_24'=>$product_24[$i],
                                'part_number_24'=>$partNumber_24[$i],
                                'quantity_24'=>$quantity_24[$i],
                                'brand_name_25'=>$brand_name_25[$i],
                                'order_name_25'=>$product_25[$i],
                                'part_number_25'=>$partNumber_25[$i],
                                'quantity_25'=>$quantity_25[$i],
                                'brand_name_26'=>$brand_name_26[$i],
                                'order_name_26'=>$product_26[$i],
                                'part_number_26'=>$partNumber_26[$i],
                                'quantity_26'=>$quantity_26[$i],
                                'brand_name_27'=>$brand_name_27[$i],
                                'order_name_27'=>$product_27[$i],
                                'part_number_27'=>$partNumber_27[$i],
                                'quantity_27'=>$quantity_27[$i],
                                'brand_name_28'=>$brand_name_28[$i],
                                'order_name_28'=>$product_28[$i],
                                'part_number_28'=>$partNumber_28[$i],
                                'quantity_28'=>$quantity_28[$i],
                                'brand_name_29'=>$brand_name_29[$i],
                                'order_name_29'=>$product_29[$i],
                                'part_number_29'=>$partNumber_29[$i],
                                'quantity_29'=>$quantity_29[$i],
                                'brand_name_30'=>$brand_name_30[$i],
                                'order_name_30'=>$product_30[$i],
                                'part_number_30'=>$partNumber_30[$i],
                                'quantity_30'=>$quantity_30[$i],
                                'brand_name_31'=>$brand_name_31[$i],
                                'order_name_31'=>$product_31[$i],
                                'part_number_31'=>$partNumber_31[$i],
                                'quantity_31'=>$quantity_31[$i],
                                'brand_name_32'=>$brand_name_32[$i],
                                'order_name_32'=>$product_32[$i],
                                'part_number_32'=>$partNumber_32[$i],
                                'quantity_32'=>$quantity_32[$i],
                                'brand_name_33'=>$brand_name_33[$i],
                                'order_name_33'=>$product_33[$i],
                                'part_number_33'=>$partNumber_33[$i],
                                'quantity_33'=>$quantity_33[$i],
                                'brand_name_34'=>$brand_name_34[$i],
                                'order_name_34'=>$product_34[$i],
                                'part_number_34'=>$partNumber_34[$i],
                                'quantity_34'=>$quantity_34[$i],
                                'brand_name_35'=>$brand_name_35[$i],
                                'order_name_35'=>$product_35[$i],
                                'part_number_35'=>$partNumber_35[$i],
                                'quantity_35'=>$quantity_35[$i],
                                'brand_name_36'=>$brand_name_36[$i],
                                'order_name_36'=>$product_36[$i],
                                'part_number_36'=>$partNumber_36[$i],
                                'quantity_36'=>$quantity_36[$i],
                                'brand_name_37'=>$brand_name_37[$i],
                                'order_name_37'=>$product_37[$i],
                                'part_number_37'=>$partNumber_37[$i],
                                'quantity_37'=>$quantity_37[$i],
                                'brand_name_38'=>$brand_name_38[$i],
                                'order_name_38'=>$product_38[$i],
                                'part_number_38'=>$partNumber_38[$i],
                                'quantity_38'=>$quantity_38[$i],
                                'brand_name_39'=>$brand_name_39[$i],
                                'order_name_39'=>$product_39[$i],
                                'part_number_39'=>$partNumber_39[$i],
                                'quantity_39'=>$quantity_39[$i],
                                'brand_name_40'=>$brand_name_40[$i],
                                'order_name_40'=>$product_40[$i],
                                'part_number_40'=>$partNumber_40[$i],
                                'quantity_40'=>$quantity_40[$i],
                                'brand_name_41'=>$brand_name_41[$i],
                                'order_name_41'=>$product_41[$i],
                                'part_number_41'=>$partNumber_41[$i],
                                'quantity_41'=>$quantity_41[$i],
                                'brand_name_42'=>$brand_name_42[$i],
                                'order_name_42'=>$product_42[$i],
                                'part_number_42'=>$partNumber_42[$i],
                                'quantity_42'=>$quantity_42[$i],
                                'brand_name_43'=>$brand_name_43[$i],
                                'order_name_43'=>$product_43[$i],
                                'part_number_43'=>$partNumber_43[$i],
                                'quantity_43'=>$quantity_43[$i],
                                'brand_name_44'=>$brand_name_44[$i],
                                'order_name_44'=>$product_44[$i],
                                'part_number_44'=>$partNumber_44[$i],
                                'quantity_44'=>$quantity_44[$i],
                                'brand_name_45'=>$brand_name_45[$i],
                                'order_name_45'=>$product_45[$i],
                                'part_number_45'=>$partNumber_45[$i],
                                'quantity_45'=>$quantity_45[$i],
                                'brand_name_46'=>$brand_name_46[$i],
                                'order_name_46'=>$product_46[$i],
                                'part_number_46'=>$partNumber_46[$i],
                                'quantity_46'=>$quantity_46[$i],
                                'brand_name_47'=>$brand_name_47[$i],
                                'order_name_47'=>$product_47[$i],
                                'part_number_47'=>$partNumber_47[$i],
                                'quantity_47'=>$quantity_47[$i],
                                'brand_name_48'=>$brand_name_48[$i],
                                'order_name_48'=>$product_48[$i],
                                'part_number_48'=>$partNumber_48[$i],
                                'quantity_48'=>$quantity_48[$i],
                                'brand_name_49'=>$brand_name_49[$i],
                                'order_name_49'=>$product_49[$i],
                                'part_number_49'=>$partNumber_49[$i],
                                'quantity_49'=>$quantity_49[$i],
                                'brand_name_50'=>$brand_name_50[$i],
                                'order_name_50'=>$product_50[$i],
                                'part_number_50'=>$partNumber_50[$i],
                                'quantity_50'=>$quantity_50[$i],
