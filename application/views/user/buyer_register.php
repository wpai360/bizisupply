...
";
              ...
              ?>
                            <div class="form-row justify-content-center align-items-center">
                                ...
                                <div class="form-group col-md-2"><select style="border-radius:25px" class="form-control"
                      ...
                      ?>
                                        <option <?php echo set_select('category', $categoryValue->id); ?>
                                            value="<?php echo $categoryValue->id; ?>">
                    ...
                    echo form_input(array('style' => 'border-radius:25px', 'name' => 'itemno_' . $i, 'placeholder' => 'Item/Serial Number')); ?>
                                ...
                                <div class="form-group col-md-2">
                                    <?php
                    echo form_input(array('style' => 'border-radius:25px', 'name' => 'prefer_' . $i, 'placeholder' => 'Preferred Supplier')); ?>
                                </div>
