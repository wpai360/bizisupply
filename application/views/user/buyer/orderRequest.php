...
<div class="sg-select-container">
    ...
    <button type="button" data-toggle="modal" data-target="#masterModal"
        data-intro="The quickest and most accurate way to make a new order by keeping your master list up to date"
        class="btn btn-primary mb-2">Select a product from master list:</button>
    <?php if (!empty($supplier_list)) { ?>
        <button type="button" data-toggle="modal" id="select_prefeer" data-target="#preferredModal"
            class="btn btn-primary mb-2">Select Preferred Suppliers</button>
                                ...
                                foreach ($master_list as $master_listValue) {
                                    ...
                                    <tr class="ref text-black masterProduct">
                                        ...
                                        if (!empty($supplier_list)) { ?>
                                            ...
                                            <td><button type="button" data-toggle="modal" id="select_prefeer"
                                                    data-target="#preferredModal" class="btn btn-success mb-2">Select Preferred
                                                    Suppliers</button></td>
                                        <?php } ?>
                                        <td>
                                            <button type="button" class="btn btn-primary"
                                                id="master_<?php echo $master_listValue->master_id; ?>"
                                                onclick="masterListSelect(<?php echo $master_listValue->master_id; ?>)">Add to
                                                order</button>
                                        </td>
            ...
            <div class="modal-body">
                <div class="table-responsive">
                   ...
                   <span class="fa fa-star checked"></span>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-primary"
                                                id="s_<?php echo $supplier->supplier_id; ?>"
                                                onclick="selectSupplier(<?php echo $supplier->supplier_id;
                                                echo ',s_';
                                                echo $supplier->supplier_id; ?>)">Select
                                        </td>
                                    <?php }
                            } ?>
                            </tr>
        ...
        <div class="row-outdoor-container width-100">
            <div class=" row width-100 padding-left-15">
                <div class="form-group custom_boxshadow col-md-12" style="margin:auto;">
                    ...
                    <div class="sg-select-container"
                        data-intro="Select the category that you matches your request. You can order up to 10 products under 1 category. Can't find a logical category? Click here to tell us what's missing. Help us help you.">
                    ...
                    <div class="row productrow border-bottom border-info">
                        <div class="col-lg-3">
                            ...
                            <div class="sg-select-container" id="productabc">
                                <input required type="text" name="product_1[]" class="product custom_input"
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="sg-select-container">
                                ...
                                <input required type="text" name="brand_name_1[]" placeholder="Brand name"
                                    id="brand_name_1" class="custom_input brand_name" />
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="sg-select-container">
                                <input required type="text" name="partNumber_1[]" id="partNumber_1"
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="sg-select-container">
                                <input required type="number" name="quantity_1[]" id="quantity_1" placeholder="quantity"
                                    class="custom_input quantity_no" />
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="sg-select-container">
                                <input required type="text" name="volume_1[]" id="volume_1"
                                    placeholder="Measurement/Volume" class="custom_input volume_no" />
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="sg-select-container">
                                <textarea required type="text" name="note_1[]" id="note_1"
                                    placeholder="describe more about the product? e.g. options, color... Any constructive information that will be help to define the products you are looking for"
                                    class="custom_input note"></textarea>
                        ...
                        <div class="col-lg-3">
                            ...
                            <input
                                data-intro="We all know the saying:' A picture is worthing a thousand words.' 2 pictures allowed. You can upload the photo you take or screenshot from your mobile or computer "
                                class="supplier-image" type="file" name="image1" value="" id='1'>
                            <img id="cu1" width="100" height="80" src="<?= base_url(); ?>assets/images/camera.png">
                            <i class="fas fa-trash" aria-hidden="true" id="image1"
                        ...
                        <div class="col-lg-3">
                            <label for="state" class="control-label">Image</label>
                            <input
                                data-intro="<a target='_blank' href='www.google.com'>Click here to see how to upload the photos from your phone</a>"
                                class="supplier-image" type="file" name="image2" value="" id='2'>
                            <img id="cu2" width="100" height="80" src="<?= base_url(); ?>assets/images/camera.png">
                            <i class="fas fa-trash" aria-hidden="true" id="image2"
                                style="font-size:30px;color:red;"></i>
                            <br>
                        </div>
                        ...
                        <div class="sg-select-container col-lg-12">
                            <button type="button" onclick="checkMaster(this)"
                                data-intro="click the button below to save a new product into the master list for next time, save time and make your master list more smarter"
                                class="mb-2 btn btn-primary master-save">Send to Masterlist</button>
                        </div>
                    ...
                    <div class="sg-select-container"
                        data-intro="Buyer select the most properly delivery system, but be aware your supplier might offer some alternative time."
                    ...
                    <div class="sg-select-container">
                        <input min="<?php echo date("Y-m-d"); ?>" required type="date" id="prefer_delivery_date"
                            name="prefer_delivery_date[]" class="date1 custom_input"
                            placeholder="prefer_delivery_date" />
                        <br>

                        <div style="color: red; font-size:24px;"
                            data-intro="Urgent delivery are only for urgent matters, e.g machinery breakdown">
                    ...
                    <div id="map-app">
                        ...
                        <select name="delivery_method" v-model="selected" id="region-select">
                            <option v-for="option in options" :value="option.id" :key="option.value">{{option.value}}
                            </option>
                        </select>
                        <div v-if="selected === 1">
                        ...
                        <div v-if="selected === 2">
                            <iframe id="region-map" src="https://bizisupply.com/map.html" width="800" height="500"
                    ...
                    <div class="sg-select-container">
                        <textarea required type="text" name="description[]" id="description"
                            placeholder="Information for suppliers" class="custom_input" /></textarea>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="sg-select-container" id="">
                                        ...
                                        <img id="pop4" class="imagen d-none" src="" alt="your image" height="100"
                                            width="100" />
                                        <img id="pop5" class="imagen d-none" src="" alt="your image" height="100"
                                            width="100" />
                                    </div>
                                    <div class="sg-select-container" id="">
                                        <img id="pop6" class="imagen d-none" src="" alt="your image" height="100"
                                            width="100" />
                                        <img id="pop7" class="imagen d-none" src="" alt="your image" height="100"
                                            width="100" />
                                        <img id="pop8" class="imagen d-none" src="" alt="your image" height="100"
                                            width="100" />
                                        <img id="pop9" class="imagen d-none" src="" alt="your image" height="100"
                                            width="100" />
                                        <img id="pop10" class="imagen d-none" src="" alt="your image" height="100"
                                            width="100" />
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <input type="submit" class="btn_custom_btn" name="Save_As_Draft"
                                        value="Save As Draft">
                                    <input type="submit" name="submit" value="confirm"
                                        class='btn btn-default custom_btn_color'>
                                    <input type="button" class="btn btn-default custom_btn_color" data-dismiss="modal"
                                        value="Close">
                                </div>
                    ...
                    <button type="button" class="btn btn-primary btn-lg abc" data-toggle="modal" data-target="#myModal"
                        id="Preview">Preview</button>

                    <a style="margin-top: 17px;" class="btn btn-primary btn-lg"
                        href="<?php echo base_url('buyer/buyerOrderDashboard'); ?>" class="cancel">Cancel</a>
