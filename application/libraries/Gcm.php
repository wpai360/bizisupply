...
class Gcm
	...
	public function setTtl($ttl = '')
		{
			if (!$ttl) unset($this->payload['time_to_live']);
			  else $this->payload['time_to_live'] = $ttl;
		}
	...
	public function setData($data = array())
		{
			...
			if ($this->message) $this->payload['data']['message'] = $this->message;
		}
	...
	public function setGroup($group = '')
		{
			if (!$group) unset($this->payload['collapse_key']);
			  else $this->payload['collapse_key'] = $group;
		}
	...
	public function send()
		{
			...
			if (isset($this->payload['time_to_live']) && !isset($this->payload['collapse_key'])) $this->payload['collapse_key'] = 'GCM Notifications';
