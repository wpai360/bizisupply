...
<!-- beign of a product row -->
 ...
 class="custom_input note"><?php echo $getOrderDetails[0]->note_1;?></textarea>
       ...
       <div class="sg-select-container col-lg-6">
        ...
        <?php if($getOrderDetails[0]->image1!=NULL){echo "<img id='cu1' width='100' height='80' src='";echo  base_url();echo  "uploads/" ;echo $getOrderDetails[0]->image1;echo "' <i class='fa fa-trash' aria-hidden='true' id='image1' style='font-size:30px;color:red;' ></i><br>";}else{
...
<div class = "add-row-outdoor row width-100" style="padding-left:15px;">
 ...
 class="custom_input note"><?php echo $getOrderDetails[0]->{'note_'.$j};?></textarea>
    ...
    <!-- end of product rows -->
      ...
      <div class="sg-select-container">
       <input  required type="date" value="<?php echo $getOrderDetails[0]->prefer_delivery_data;?>" id="prefer_delivery_date" name="prefer_delivery_date[]" class="date1 custom_input" placeholder="prefer_delivery_date"/>
