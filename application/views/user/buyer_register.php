            ...
            ?>
              ...
              ?>
                ...
                ?>
                            ...
                            <div class="form-group col-md-6">
                                <?php
                echo form_input(array('name' => 'yearsInBusiness', 'type'=>'number' , 'class' => "years form-control", 'placeholder' => 'How many years in business?',  'value' => set_value('how many years?')));
                ?>
                            </div>
                        </div>
                        <div class="form-row">
                          <div class="form-group col-md-6">
                               <select id="" name="socialMedia" class='form-control'>
                          ...
                          <div class="form-group col-md-6">
                                <?php
                echo form_input(array('name' => 'businessWeb', 'class' => "website form-control", 'placeholder' => 'Company Website',  'value' => set_value('website')));
                ?>
                          </div>
                        </div>
                        <div class="form-row">
                          <div class="form-group col-md-6">
                              <select id="" name="businessSize" class='form-control'>
                                <option value="">Business size</option>
                                <option value="0">1 - 10 employees</option>
                                <option value="11">11 - 50 employees</option>
                                <option value="51">51 - 100 employees</option>
                                <option value="101">101 - 200 employees</option>
                                <option value="201">201 - 500 employees</option>
                                <option value="501">More than 500 employees</option>
                              </select>
                          </div>
                          <div class="form-group col-md-6">
...
function acnAjaxCall(acn) {
    ...
    $.ajax({
        ...
        url: "https://abr.business.gov.au/json/AbnDetails.aspx?abn=" + acn +
            "&guid=f43417c6-f163-4db0-987f-becb873c84d7",
        dataType: "jsonp",
...
$(document).ready(function() {
    ...
    $.validator.addMethod('password', function(value, element) {
            return this.optional(element) || (value.match(/[a-z]/) && value.match(/[A-Z]/) && value.match(
                /[0-9]/) && value.match(/[!@#$%&*()_+=-|<>?{}~]/));
        },
    ...
    $.validator.addMethod('tPhone', function(value) {
        return /^\(?(?:\+?61|0)(?:2\)?[ -]?(?:3[ -]?[38]|[46-9][ -]?[0-9]|5[ -]?[0-35-9])|3\)?(?:4[ -]?[0-57-9]|[57-9][ -]?[0-9]|6[ -]?[1-67])|7\)?[ -]?(?:[2-4][ -]?[0-9]|5[ -]?[2-7]|7[ -]?6)|8\)?[ -]?(?:5[ -]?[1-4]|6[ -]?[0-8]|[7-9][ -]?[0-9]))(?:[ -]?[0-9]){6}$/
            .test(value);
    ...
    $.validator.addMethod('mPhone', function(value) {
        return /^(?:\+?61|0)4 ?(?:(?:[01] ?[0-9]|2 ?[0-57-9]|3 ?[1-9]|4 ?[7-9]|5 ?[018]) ?[0-9]|3 ?0 ?[0-5])(?: ?[0-9]){5}$/
            .test(value);
    ...
    $('.abn').on('keyup', function() {
        ...
        $.ajax({
            ...
            url: "https://abr.business.gov.au/json/AbnDetails.aspx?abn=" + val +
                "&guid=f43417c6-f163-4db0-987f-becb873c84d7",
            dataType: "jsonp",
            success: function(result) {
                        ...
                        if (val.length == 11 && result.Message == '') {
                            ...
                            setTimeout(function() {
                                if (acnValidate == true) {
                                    ...
                                    'please enter a correct ABN/ACN number'
                                ));
